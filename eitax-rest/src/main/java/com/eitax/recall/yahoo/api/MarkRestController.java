...
public class MarkRestController {
	...
	@RequestMapping(value="{yahooAuctionItemId}",method = RequestMethod.GET,produces = "application/json")
	public Result putMark(@PathVariable Integer yahooAuctionItemId, @RequestParam Integer markId,UriComponentsBuilder uriComponentsBuilder) {
